...
data class GitHubRepositoryModel(
    ...
    @SerializedName("owner") var owner: GitHubOwnerModel? = GitHubOwnerModel(),
    ...
    @SerializedName("license") var license: GitHubLicenseModel? = GitHubLicenseModel()
): IGitHubSearchResponseItemModel